...
Supplementary Table S1, S2 & Image S1  
...
\hline
\end{tabular}
Table S1. Final parameters for the two models which met the minimum NSE threshold. See Supplement #2 for parameter descriptions.
